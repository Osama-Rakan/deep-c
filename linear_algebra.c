...
void linear_algebra_matrix_multiplication(double* mat1, size_t total_size1, size_t row_size1, double* mat2, size_t total_size2, size_t row_size2, double* results){
  int mat1_number_of_rows = total_size1 / row_size1; // same as results_number_of_rows
  int mat1_number_of_cols = row_size1 / sizeof(double);
  int mat2_number_of_cols = row_size2 / sizeof(double); // same as results_number_of_cols

  for(int mat1_current_row=0;mat1_current_row<mat1_number_of_rows;mat1_current_row++){
    for(int mat2_current_col=0;mat2_current_col<mat2_number_of_cols;mat2_current_col++){
      results[mat1_current_row * mat2_number_of_cols + mat2_current_col] = 0;
      for(int mat1_current_col=0;mat1_current_col<mat1_number_of_cols;mat1_current_col++){
